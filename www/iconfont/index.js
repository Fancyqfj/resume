		...
		$.post('api/work', {}, function(sk) {
			...
			for(var i = 0; i < sk.length; i++) {
				...
				str = "<dt>" + sk[i].title + "</dt>" +
					"<dd>" + sk[i].content + "</dd>";
				$("#scroller div dl").append(str);
			}
			$("#scroller div dl").append("<dt>曾在公司</dt><dd><img src='images/qtfm.jpg' /></dd><dd>公司官网：http://neo.qingting.fm/<dd>");
		myScroll.refresh();
		});
